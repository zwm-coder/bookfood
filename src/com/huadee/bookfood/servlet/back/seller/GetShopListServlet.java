...
@WebServlet(name = "GetShopListServlet", urlPatterns = "/back/seller/shop/list")
public class GetShopListServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String path = "/pages/errors.jsp";
        String seller_id = req.getParameter("seller_id");
        int pageSize = 10;
        String osql= "select count(*) as total from shop where seller_id="+seller_id+" and status=1";
        ...
        if (ValidateUtil.validateEmpty(seller_id)){
            shopList = ShopService.getShopList(page, pageSize, Integer.parseInt(seller_id), 1);
            path = "/pages/back/seller/index.jsp";
        }
