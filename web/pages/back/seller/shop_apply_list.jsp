        ...
        <div class="content-container">
            ...
            <c:if test="${empty requestScope.shopList}">
                <div class="not-found" style="margin-top: 100px; text-align: center;">
                    ...
                    <p>暂时还没申请哦！</p>
                    <a href="/pages/back/seller/shop_add.jsp" class="uk-button uk-button-primary uk-button-small" style="float: right"><span uk-icon="icon: plus"></span>立即添加店铺</a>
                </div>
            </c:if>
                    ...
                    <ul>
                        <c:forEach items="${requestScope.shopList}" var="shop">
                            <li class="shop-item uk-card uk-card-default uk-card-body">
                                <div class="img">
                                    <img src="/upload/img/<c:out value="${shop.getShop_out_photo()}"></c:out>" alt="">
                                </div>
                                <div class="info">
                                    <p>
